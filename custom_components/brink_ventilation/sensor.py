...
from .sensors.frost_heater_power_sensor import FrostHeaterPowerSensor
from .sensors.frost_fan_reduction_sensor import FrostFanReductionSensor
...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities([
        ...
        FrostHeaterPowerSensor(coordinator, entry.entry_id),
        FrostFanReductionSensor(coordinator, entry.entry_id),
